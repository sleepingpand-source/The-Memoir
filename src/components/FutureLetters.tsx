...
const getLetterContent = (age: number) => {
  if (age === 17) return "Dear Aleena, you are 17 today! The whole world is ahead of you. Keep coding, keep dreaming, and never lose your radiant spark. I love you endlessly.";
          ...
          return (
            ...
            >
              <button
                ...
                disabled={!isUnlocked}
                className={`w-full relative aspect-[3/4] rounded-xl flex flex-col items-center justify-center p-4 transition-all duration-500 overflow-hidden ${
                  isUnlocked 
